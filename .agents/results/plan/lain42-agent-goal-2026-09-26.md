...
把 Lain42 做成打开网页或手机即可使用的全平台 Agent：默认使用网站模型，先确保“真实聊天、资料检索后回答、附件分析”三条完整流程可靠；账户与资料严格隔离；只有需要操作 CLI 或项目时，才连接用户本人授权的设备。客户端承担适合浏览器运行的解析和展示；Lain42 统一管理积分、用量与知识空间。
...
| 浏览器公开搜索后回答 | 尚未完成“真实搜索结果进入同轮模型、回答引用来源”的验收 | 未通过 |
